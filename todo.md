...
- What happens if the sun rises before 1AM or sets after 11PM?

## Theme config files

- [x] ashell (`~/.config/ashell/config.toml`)
- [x] clipse (`~/.config/clipse/custom_theme.json`)
